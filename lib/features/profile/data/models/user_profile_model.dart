...
abstract final class UserProfileModel {
  static UserProfile fromRow(models.Row row) {
    ...
    return UserProfile(
      ...
      skillLevel: _string(data['skill_level']),
      ...
      salaryRange: _string(data['salary_range']),
      locationLabel: _string(data['location_label']),
      locationCity: _string(data['location_city']),
      locationState: _string(data['location_state']),
      locationCountry: _string(data['location_country']),
