    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected = PlaySession.isSameDay(date, selectedDate);
          return PlayDateChip(
            date: date,
            sessionCount: sessionCountByDate[PlaySession.dateStamp(date)] ?? 0,
...
class PlayDateChip extends StatelessWidget {
  const PlayDateChip({
    required this.date,
